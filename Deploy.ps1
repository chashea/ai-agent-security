...
try {
    ...
    # Apply TestUsersMode override — defaults to 'create'
    ...
    if (-not $SkipAuth) {
        ...
        Connect-LabServices -TenantId $TenantId -ConnectAzure:$deployFoundry -AzureSubscriptionId $azureSubscriptionId
        $connectMsg = if ($deployFoundry) {
